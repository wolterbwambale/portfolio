        ...
        <div className={styles.content}> 
            ...
            <ul className={styles.aboutItems}>
                <li className={styles.aboutItem}>
                    <img src={getImageUrl("about/user-experience.png")} alt="pointer" className={styles.aboutImage} />
                ...
                <li className={styles.aboutItem}>
                    <img src={getImageUrl("about/user-interface.png")} alt="pointer"className={styles.aboutImage} />
                <div className={styles.aboutItemText}>
                <h3>UI Design</h3>
